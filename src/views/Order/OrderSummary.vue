    ...
    <section class="py-24 relative">
      <div class="w-full p-2 px-8 md:px-5 lg-6 mx-auto">
        <div class="flex items-start flex-col gap-6 xl:flex-row">
          <div
            class="w-full max-w-full md:max-w-full xl:max-w-sm items-start gap-8 max-xl:mx-auto"
          >
            <div
              class="p-6 border border-gray-200 rounded-3xl w-full group transition-all duration-500 hover:border-gray-400"
            >
              <h2
              ...
              <div class="data py-6 border-b border-gray-200">
                <div class="flex items-center justify-between gap-4 mb-5">
                  <p
                    class="font-normal text-lg leading-8 text-gray-400 transition-all duration-500 group-hover:text-gray-700"
                  >
                    Product Cost
                  </p>
                ...
                <div class="flex items-center justify-between gap-4">
                  ...
                  <p
                    class="font-normal text-lg leading-8 text-blue-400 transition-all duration-500 group-hover:text-blue-700"
                  >
                    {{ promoCode }}
                  </p>
          ...
          <div v-for="product in products" :key="product.id">
            <div
              class="rounded-3xl p-6 bg-gray-100 border border-gray-100 flex flex-row md:flex-col md:items-center gap-5 max-w-full md:max-w-3xl mx-auto"
            >
              <div class="img-box">
                <img
                  :src="product.image"
              ...
              <div
                class="grid grid-cols-1 md:grid-cols-2 w-full gap-3 md:gap-8"
              >
                <div>
