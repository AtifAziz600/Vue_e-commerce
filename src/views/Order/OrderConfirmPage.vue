<template>
  <AppLayout>
    <section
      class="py-24 relative bg-gradient-to-br from-gray-100 to-gray-200 min-h-screen"
    >
      <div
      ...
      >
        <div class="flex flex-col items-center gap-10 py-10">
          <div class="flex flex-col items-center gap-2">
            <svg
              class="w-16 h-16 text-green-500 mb-2"
              fill="none"
              stroke="currentColor"
              stroke-width="2"
              viewBox="0 0 24 24"
            ...
            <h2
              class="text-center text-gray-900 text-3xl font-bold font-sans tracking-tight"
            >
              {{ customerName }}, Thank You for Your Order!
            </h2>
            <p
              class="max-w-xl text-center text-gray-500 text-lg font-normal leading-8"
            >
          ...
          <div class="w-full flex flex-col gap-8">
              ...
              <div>
                ...
                >
                  <div class="flex items-center gap-4">
                    <img
                      class="object-cover w-16 h-16 rounded-lg border border-gray-200 shadow"
                      :src="item.image"
                      :alt="item.alt"
                    />
                    <div>
            ...
            <div class="flex flex-col md:flex-row gap-6">
              <div
                class="flex-1 rounded-xl border border-gray-200 bg-white shadow-sm p-6 flex flex-col gap-4"
              >
                ...
                <div
                  class="flex justify-between items-center border-y border-gray-100 py-4"
                >
                  <span class="text-gray-500 font-medium"
