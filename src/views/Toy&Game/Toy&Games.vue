    ...
    products: [
      {
        ...
        reviews: 1100,
        rating: 4,
        features: ["10 die-cast cars", "Variety of styles", "Ages 3+"],
        sizes: [],
      },
      {
        id: 6,
        ...
        reviews: 1450,
        rating: 5,
        features: ["54 hardwood blocks", "For 1 or more players", "Ages 6+"],
        sizes: [],
      },
      {
        id: 7,
        ...
        inStock: false,
        subtitle:
          "Three-story Barbie Dreamhouse with furniture and accessories.",
        image: Toy7,
        oldPrice: 199.99,
        newPrice: 179.99,
        discount: 10,
      ...
      },
      {
        ...
        reviews: 950,
        rating: 4,
        features: ["10 colors", "Non-toxic", "Ages 2+"],
        sizes: [],
      },
    ],
  },
