    ...
    <section class="px-6 lg:px-0 max-w-3xl mx-auto -mt-20 lg:-mt-32 pb-10">
      <div class="rounded-2xl bg-white shadow-lg p-6 relative z-10">
        <div class="flex items-center gap-5">
          <img class="w-16 h-16 lg:w-24 lg:h-24 rounded-full border-4 border-white shadow-md object-cover"
      ...
      <div class="mt-10">
        <div class="flex justify-between items-center mb-5 bg-white rounded-lg px-4 py-2 shadow-sm border">
          ...
          <button @click="authStore?.logout" class="text-sm text-red-500 hover:underline flex items-center gap-1">
          ...
          <div v-if="customer?.combine_orders?.length" class="space-y-4">
            <div v-for="(order, i) in customer.combine_orders" :key="i"
              ...
              <div class="w-28 h-28 rounded-lg bg-gray-100 overflow-hidden">
                <img :src="order?.orders?.[0]?.order_details?.[0]?.product
        ...
        <div v-if="activeTab === 1" class="mt-4">
          <div v-if="customerLoading" class="w-full border bg-white border-gray-300 rounded-md p-4 animate-pulse">
          ...
          <div v-if="customer?.addresses?.[0]" class="mt-5">
            <div class="bg-white border border-gray-200 rounded-lg shadow p-4 text-sm text-gray-800">
