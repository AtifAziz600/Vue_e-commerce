          ...
          >
            <div class="w-full flex-col justify-center items-start gap-8 flex">
              ...
              >
                ...
                >
                  <h2
                    class="text-cardColour text-4xl font-bold font-manrope leading-normal lg:text-start text-center"
                  >
                  ...
                  >
                    At ShopWise, we’re more than just a store. We're your
                    partner in discovering top-quality products at unbeatable
                    prices. Since our beginning, customer satisfaction, fast
                    delivery, and curated collections have been at our core.
                  </p>
                </div>
              </div>
              <div
                ...
                >
                  ...
                  >
                    ...
                    <p
                      class="text-gray-500 text-base font-normal leading-relaxed"
                    >
                      Average review from happy customers
                    </p>
                  </div>
                  <div
                    class="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex"
            ...
            <button
              class="sm:w-fit w-full group px-3.5 py-2 bg-cardColour-50 hover:bg-cardColour-100 rounded-lg shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 ease-in-out justify-center items-center flex"
            >
              <span
                class="px-1.5 text-cardColour text-sm font-medium leading-6 group-hover:-translate-x-0.5 transition-all duration-700 ease-in-out"
                >About Us</span
              >
              <Icon icon="mdi:arrow-right" class="w-6 h-6 text-cardColour" />
            </button>
          </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <p
                  class="text-gray-500 text-sm font-normal text-start md:text-center"
                >
