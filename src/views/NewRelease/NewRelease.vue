  ...
  >
    {{ item.inStock ? 'In Stock' : 'Out of Stock' }}
                            ...
                            <button
                              ...
                              class="flex items-center gap-2 bg-deepMaroon border text-white text-sm font-semibold px-4 py-1.5 rounded-lg shadow hover:bg-red-900 hover:border-red-900 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-red-800"
                            >
