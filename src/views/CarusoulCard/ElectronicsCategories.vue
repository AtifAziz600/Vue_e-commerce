    ...
    <div class="max-w-full mx-auto px-4">
      <div class="flex items-center gap-2 justify-start">
        <h2 class="text-xl sm:text-2xl font-semibold text-black">
          Catch low prices in the Electronics category
        ...
        >
          ...
          <div class="px-4 pb-4">
            ...
            <div class="flex items-center py-1">
              ...
              <p
                class="text-sm mt-1 text-gray-700 leading-tight line-clamp-2 cursor-pointer"
              >
                {{ product.rating }}
              </p>
            </div>
...
const products = [
  ...
  },
  {
    ...
    reviews: 420,
    rating: 4.6,
    features: ["Intel i7 / Ryzen 7", "RTX 4060 GPU", "16GB RAM, 512GB SSD"],
    sizes: ['15.6"', '17.3"'],
  },
  {
    id: 67,
    ...
    reviews: 310,
    rating: 4.4,
    features: ["Waterproof (IPX7)", "12-hour battery", "Built-in mic"],
    sizes: ["Small", "Medium"],
  },
  {
    id: 68,
    ...
    reviews: 145,
    rating: 4.5,
    features: ["Hot-swappable keys", "Wireless + USB-C", "RGB backlight"],
    sizes: ["75%", "TKL", "Full"],
  },
  {
    id: 69,
