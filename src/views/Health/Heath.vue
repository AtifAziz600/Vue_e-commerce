...
const products = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        inStock: true,
        subtitle:
          "Contactless thermometer for instant and hygienic temperature readings.",
        image: Health2,
        oldPrice: 39.99,
        newPrice: 29.99,
        discount: 25,
      ...
      },
      {
        ...
        inStock: false,
        subtitle:
          "Monitor your blood oxygen saturation and pulse rate at home.",
        image: Health3,
        oldPrice: 29.99,
        newPrice: 19.99,
        discount: 33,
    ...
    products: [
      {
        ...
        inStock: true,
        subtitle:
          "Track your steps, heart rate, and sleep with this smart band.",
        image: Health5,
        oldPrice: 49.99,
        newPrice: 34.99,
        discount: 30,
      ...
      },
      {
        ...
        inStock: false,
        subtitle:
          "Relieve muscle soreness and improve recovery with deep tissue massage.",
        image: Health8,
        oldPrice: 99.99,
        newPrice: 69.99,
        discount: 30,
