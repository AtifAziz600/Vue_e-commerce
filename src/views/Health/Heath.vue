  ...
  >
    {{ item.inStock ? 'In Stock' : 'Stock Out' }}
                            ...
                            <button
                              ...
                              class="flex items-center gap-2 bg-primarysButton hover:bg-secondysButton border text-white text-sm font-semibold px-4 py-1.5 rounded-lg shadow hover:border-red-900 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-red-700"
                            >
