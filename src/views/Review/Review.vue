  ...
  <AppLayout>
    <section class="py-24 relative">
      <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
        <div class="w-full">
          <h2
            class="font-manrope font-bold text-4xl text-black mb-8 text-center"
          >
          ...
          >
            <div class="box flex flex-col gap-y-4 w-full">
              <div class="flex items-center w-full">
                ...
                >
                  <span
                    class="h-full w-[30%] rounded-3xl bg-amber-400 flex"
                  ></span>
                </p>
              ...
              <div class="flex items-center w-full">
                ...
                >
                  <span
                    class="h-full w-[40%] rounded-3xl bg-amber-400 flex"
                  ></span>
                </p>
              ...
              <div class="flex items-center">
                ...
                >
                  <span
                    class="h-full w-[20%] rounded-3xl bg-amber-400 flex"
                  ></span>
                </p>
              ...
              <div class="flex items-center">
                ...
                >
                  <span
                    class="h-full w-[16%] rounded-3xl bg-amber-400 flex"
                  ></span>
                </p>
              ...
              <div class="flex items-center">
                ...
                >
                  <span
                    class="h-full w-[8%] rounded-3xl bg-amber-400 flex"
                  ></span>
                </p>
            ...
            >
              ...
              <p
                class="font-medium text-xl leading-8 text-gray-900 text-center"
              >
                46 Ratings
              </p>
            </div>
          ...
          >
            ...
            <h3
              class="font-manrope font-semibold text-xl sm:text-2xl leading-9 text-black mb-6"
            >
            ...
            <p
              class="font-normal text-lg leading-8 text-gray-400 max-xl:text-justify"
            >
