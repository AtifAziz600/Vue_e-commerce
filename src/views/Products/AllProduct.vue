    ...
    <div class="max-w-full mx-auto py-4 pt-8">
      <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="mb-6">
              ...
              <div class="px-2">
                <input type="range" v-model="priceRange[0]" :min="minPrice" :max="maxPrice"
                  class="w-full accent-deepMaroon mb-2 bg-gray-300" @input="updatePriceRange" />
                <input type="range" v-model="priceRange[1]" :min="minPrice" :max="maxPrice"
                  class="w-full accent-deepMaroon bg-gray-300" @input="updatePriceRange" />
              </div>
            ...
            <div class="mb-6">
              ...
              <div class="space-y-2">
                <label class="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" v-model="discountFilter" value="10"
                    class="form-checkbox text-deepMaroon focus:ring-deepMaroon rounded" />
                  <span class="text-sm">10% & above</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" v-model="discountFilter" value="20"
                    class="form-checkbox text-deepMaroon focus:ring-deepMaroon rounded" />
                  <span class="text-sm">20% & above</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" v-model="discountFilter" value="30"
                    class="form-checkbox text-deepMaroon focus:ring-deepMaroon rounded" />
            ...
            <div class="mb-6">
              ...
              <div class="space-y-2">
                <label v-for="rating in [4, 3, 2, 1]" :key="rating" class="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" v-model="ratingFilter" :value="rating"
                    class="form-checkbox text-deepMaroon focus:ring-deepMaroon rounded" />
                  <span class="flex items-center">
                    <Icon v-for="i in 5" :key="i" :icon="i <= rating ? 'mdi:star' : 'mdi:star-outline'"
            ...
            <div class="w-4/5 max-w-sm bg-white h-full overflow-y-auto" @click.stop>
              ...
              <div class="p-4 space-y-6">
                <div>
                  ...
                  <div class="px-2">
                    <input type="range" v-model="priceRange[0]" :min="minPrice" :max="maxPrice"
                      class="w-full accent-deepMaroon mb-2" @input="updatePriceRange" />
                    <input type="range" v-model="priceRange[1]" :min="minPrice" :max="maxPrice"
                      class="w-full accent-deepMaroon" @input="updatePriceRange" />
                  </div>
                  <div class="flex justify-between text-sm text-gray-600 mt-2">
                    <span>zł{{ priceRange[0] }}</span>
                    <span>zł{{ priceRange[1] }}</span>
                ...
                <div v-if="categories.length > 0">
                  ...
                  <div class="space-y-2 max-h-60 overflow-y-auto">
                    <label v-for="category in categories" :key="category.id"
                      ...
                      <input type="checkbox" v-model="categoryFilter" :value="category.id"
                        class="form-checkbox text-deepMaroon focus:ring-deepMaroon rounded" />
        ...
        <div class="flex-1 w-full">
          <h2 class="text-xl md:text-2xl font-bold text-gray-900 mb-2">All Product</h2>
     ...
     <div v-else-if="productApiStore.loading === 0" class="bg-white rounded-lg p-8 text-center">
          ...
          <div v-if="filteredProducts.length > 0" class="grid grid-cols-2 lg:grid-cols-4 px-2 py-2 gap-2">
            <div v-for="item in filteredProducts" :key="item.id"
              ...
              <div v-if="item.discount_price && item.price"
              ...
              <div class="p-4">
                ...
                <div class="flex items-baseline gap-2 mb-3">
                  ...
                  <span v-if="item.discount_price && item.price" class="text-xs line-through text-gray-400">
                    zł{{ item.price }}
                  </span>
                ...
                <div class="flex items-center mb-4">
                  <div class="flex items-center">
                    <Icon v-for="i in 5" :key="i" icon="mdi:star" class="h-4 w-4"
                ...
                <div class="flex justify-between gap-2">
                  <button @click.stop="handleBuyNow(item)"
