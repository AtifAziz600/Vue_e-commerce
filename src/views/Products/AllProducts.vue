<template>
  ...
  <section class="md:flex md:justify-between md:items-start px-4 md:px-0">
      ...
      <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-2">
          <h2 class="text-xl md:text-2xl font-bold text-gray-900 tracking-tight text-center">
                    All Products
                </h2>
  ...
  <button
    @click="handleAddToCart(item)"
    class="flex items-center justify-center gap-2 bg-deepMaroon text-white text-xs font-semibold px-4 py-1.5 rounded-lg shadow hover:bg-red-800 hover:border-red-900 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-red-400"
  >
