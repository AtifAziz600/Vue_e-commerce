...
<template>
  ...
  >
    ...
    <!-- <button 
      class="absolute top-3 right-3 p-2 bg-white rounded-full shadow-md hover:bg-gray-100 transition-colors z-10"
      @click="wishlistStore.addToWishlist(product)"
    >
    
    <Icon class="h-5 w-5 text-gray-400 group-hover:text-secondysButton" icon="mdi:heart"/>
    </button> -->
