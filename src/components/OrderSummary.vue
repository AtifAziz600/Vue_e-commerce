                ...
                <div class="w-full max-w-sm md:max-w-3xl max-xl:mx-auto">
                    <div class="grid grid-cols-1 gap-6">
                        <div class="rounded-3xl p-6 bg-gray-100 border border-gray-100 flex flex-col md:flex-row md:items-center gap-5 transition-all duration-500 hover:border-gray-400">
                            <div class="img-box ">
                                <img src="https://pagedone.io/asset/uploads/1701167635.png" alt="Denim Jacket image" class="w-full md:max-w-[122px] rounded-lg object-cover">
                            </div>
                        ...
                        <div class="rounded-3xl p-6 bg-gray-100 flex flex-col md:flex-row md:items-center gap-5 border border-gray-100 transition-all duration-500 hover:border-gray-400">
                            <div class="img-box ">
                                <img src="https://pagedone.io/asset/uploads/1701167652.png" alt="Leather Military Boots image" class="w-full md:max-w-[122px] rounded-lg object-cover">
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 w-full gap-3 md:gap-8">
                                <div class="">
                                    <h2 class="font-medium text-xl leading-8 text-black mb-3">Leather Military Boots
                                    </h2>
                                    <p class="font-normal text-lg leading-8 text-gray-500 ">Lethal Lifestyle</p>
                        ...
                        <div class="rounded-3xl p-6 bg-gray-100 flex flex-col md:flex-row md:items-center gap-5 border border-gray-100 transition-all duration-500 hover:border-gray-400">
                            <div class="img-box ">
                                <img src="https://pagedone.io/asset/uploads/1701167668.png" alt="Writing Pad image" class="w-full md:max-w-[122px] rounded-lg object-cover">
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 w-full gap-3 md:gap-8">
                                <div class="">
                                    <h2 class="font-medium text-xl leading-8 text-black mb-3">Writing Pad</h2>
                                    <p class="font-normal text-lg leading-8 text-gray-500 ">Books</p>
