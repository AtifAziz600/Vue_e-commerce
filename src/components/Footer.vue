  ...
  <footer class="w-full bg-gradient-to-br from-red-900 via-red-500 to-red-900 text-white border-t border-rose-100 py-12 md:py-16">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <span class="text-xl font-bold text-white sm:inline">What a Market</span>
    ...
    <div class="flex gap-2">
      ...
      <div class="py-8 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="flex space-x-3 sm:justify-center">
          ...
          >
            <svg class="w-[1.25rem] h-[1.125rem]" viewBox="0 0 15 15" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            <svg class="w-[1.25rem] h-[0.875rem]" viewBox="0 0 16 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
