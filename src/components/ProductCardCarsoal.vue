<template>
  <div class="bg-gradient-to-br from-gray-900 via-gray-500 to-gray-900 py-4 text-gray-900 rounded-2xl">
    <div class="max-w-full mx-auto px-4">
      <!-- Header -->
      <div class="flex items-center justify-between">
        <h2 class="text-xl sm:text-2xl font-semibold text-red-500">Up to 30% off Products brands</h2>
        <a href="#" class="text-sm text-red-600 font-semibold hover:text-red-700">See more</a>
      </div>
...
const products = [
  {
    image: Watch,
    name: 'Amazon Basics 2-Ply Flex-Sheets Paper Towels',
    price: 3.85,
    originalPrice: 4.77,
    discount: '19% off'
  },
  {
    image: Fashion,
    name: 'Amazon Basics Wipes, Lemon & Fresh Scent',
    price: 9.58,
    originalPrice: 11.28,
    discount: '15% off'
  },
  {
    image: Laptop,
    name: 'Amazon Basics Ultra Paper Bowls, 20 oz',
    price: 3.63,
    originalPrice: 4.76,
    discount: '24% off'
  },
  ...
  {
    image: Watch,
    name: 'Amazon Basics Clear Plastic Forks',
    price: 5.4,
    originalPrice: 7.43,
    discount: '27% off'
  },
  {
    image: Fashion,
    name: 'Amazon Basics Heavy Duty Staple Gun',
    price: 6.79,
    originalPrice: 8.95,
    discount: '24% off'
  },
